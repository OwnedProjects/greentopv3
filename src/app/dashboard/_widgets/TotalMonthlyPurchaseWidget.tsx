...
import {
  ...
  fetchMonthlyPurchasesTotalAndAmount,
} from '../_services/fetchMonthlyPurchasesTotalAndAmount';
...
const TotalMonthlyPurchaseWidget = () => {
  ...
  const { isLoading, data, error } = useQuery<
    ...
    GenericError
  >({
    queryKey: ['purchase-total', ts],
    queryFn: () => fetchMonthlyPurchasesTotalAndAmount(ts),
    enabled: !!(ts || ts === null),
  ...
  if (error) {
    console.log('Purchases Total Order ', error);
